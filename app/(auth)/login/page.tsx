                                ...
                                <CardContent className="space-y-5 relative">
                                    ...
                                    <div className="relative">
                                        ...
                                        <div className="relative flex justify-center text-xs uppercase">
                                            <span className="bg-gray-900 px-3 text-gray-400 font-medium">atau lanjutkan dengan</span>
                                        </div>
                                    </div>
                    ...
                    <div className="hidden lg:flex flex-col justify-center items-center">
                        ...
                        <div className="mt-8 grid grid-cols-2 gap-4 w-full max-w-md">
                            <div className="bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-xl rounded-xl p-4 text-center border border-emerald-500/20 hover:border-emerald-500/40 transition-all duration-300 group">
                                ...
                                <h4 className="font-semibold text-white text-sm mb-1">Keamanan Premium</h4>
                                <p className="text-gray-300 font-light text-xs">Perlindungan tingkat enterprise</p>
                            </div>
                            <div className="bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-xl rounded-xl p-4 text-center border border-emerald-500/20 hover:border-emerald-500/40 transition-all duration-300 group">
                                ...
                                <h4 className="font-semibold text-white text-sm mb-1">AI Monitoring</h4>
                                <p className="text-gray-300 font-light text-xs">Teknologi pembelajaran mesin</p>
                            </div>
                        </div>
                    </div>
                </div>
