        ...
        <Card className="overflow-hidden">
            ...
            <CardContent>
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between">
                    ...
                    {trend && (
                        <div className="flex items-center text-xs mt-2 sm:mt-0">
...
function ChildStatsCard({ child }: { child: any }) {
    const totalActivity = child.call_logs + child.activity_logs + child.locations
...
export function StatsOverview() {
    ...
    const totals = stats.reduce(
        (acc, child) => ({
            ...
            activityLogs: acc.activityLogs + child.activity_logs,
            locations: acc.locations + child.locations,
        }),
        { children: 0, safeZones: 0, devices: 0, callLogs: 0, activityLogs: 0, locations: 0 },
    )
        ...
        <div className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <StatCard
                    ...
                    value={totals.callLogs + totals.activityLogs + totals.locations}
